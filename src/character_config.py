...
OPTIONS = {1: {1: ('Kaz', 14745601), 2: ('Kaz Swimsuit', 14745603)}, 2: {1: ('Paz', 14745609), 2: ('Paz Swimsuit', 14745613), 3: ('Amanda', 14745605), 4: ('Amanda Sports Outfit', 14745617), 5: ('Cecile', 14745607), 6: ('Cecile Swimsuit', 14745615), 7: ('Strangelove', 14745611)}}
